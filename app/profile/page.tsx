        ...
        <div className="flex flex-col gap-8">
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-8">
            ...
            <section className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-1">
                  <label htmlFor="educationDegree" className="text-sm font-medium text-zinc-700">
                    Highest degree
                  </label>
                  <select
                    id="educationDegree"
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="educationSchool" className="text-sm font-medium text-zinc-700">
                    School / institution
                  </label>
                  <input
                    id="educationSchool"
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="educationYear" className="text-sm font-medium text-zinc-700">
                    Graduation year
                  </label>
                  <input
                    id="educationYear"
